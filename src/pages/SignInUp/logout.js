    ...
    <>
        ...
        <div className='fixed top-1/2 left-1/2 p-10 z-[1000]' style={{transform: 'translate(-50%, -50%)'}}>
            <div className='w-[17rem] h-[15rem] lg:w-[28rem] lg:h-[16.5rem] bg-white flex flex-col justify-center items-center'>
                ...
                <h3 className='text-2xl leading-[2.5rem] text-center text-[#7772D3] font-bold'>Log out</h3>
                <p className='font-normal text-base leading-5 text-center text-[#0000008A] mt-2'>Are you sure you want to log out?</p>
                <div className='mt-6'>
                  <button onClick={() => setShowLogoutModal(false)} className='mr-4 rounded-md bg-[#7772D3] px-7 py-2 text-white'>No</button>
