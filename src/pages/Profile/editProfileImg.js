...
const ProfileImg = () => {
  ...
  const { phone, setPhone, fName, setFName, lName, setLName, eMail, setEMail } =
    AppPass();
      ...
      <form>
        <div className="flex flex-col md:flex-row pl-8  pt-20">
          <div className="mr-10">
            ...
            <input
              ...
              className="rounded-md w-[18rem] h-[2.5rem] p-2 text-sm border border-[#95B4B3] text-[#95B4B3]"
            />
          </div>
          <div>
            <label className="mb-3 text-sm text-[#95B4B3] font-bold">
        ...
        <div className="flex flex-col md:flex-row pl-8">
          <div className="mr-10">
            ...
            <input
              type="phone"
              placeholder="090999999"
              onChange={(e) => setNewPhone(e.target.value)}
              className="bg-[##D9D9D921] rounded-md w-[18rem] h-[2.5rem] p-2 text-sm border border-[#95B4B3] text-[#95B4B3]"
            />
          </div>
          <div>
            <label className="mb-3 text-sm text-[#95B4B3] font-bold">
