                            ...
                            //          };
                                     ...
                                     const musicBoxEl = useRef(null);
                                          musicBoxEl.current = [];
                                              ...
                                              return (
                                                <div  className='bg-opacity-[0%] overflow-x-hidden' style={{backgroundImage: "url('marley.webp')", backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center'}}>
                                                    ...
                                                    <div className='goldenAge flex flex-col lg:w-full w-[90vw] mx-auto lg:ml-[5vw] pl-8'>
                                                        <div className='flex lg:flex-row flex-col mb-8 items-end items-left'>
                                                            ...
                                                            <div className='flex flex-col lg:w-[100%] w-[95vw] mx-auto mt-4 lg:mt-[0px]'>
                                                                <div className='text-bold text-[1.4em] text-[#829D9D] mb-2'>Reggae and Blues</div>
                                                                ...
                                                                <div className='flex items-center flex-row'>
                                                                    <button className='rounded-[20px] w-max p-2 bg-[#262A2D] text-[.7em] lg:text-[1em] flex flex-row mr-3 items-center'  onClick={() => {setIsPlaying(!isPlaying)}}><BsFillPlayCircleFill className='text-[#FACD66] w-[1em] mr-2'/> Play all</button>
                                                            ...
                                                            return (
                                                                <> 
                                                                       <div key={index} ref={musicBoxToEl} onClick={() => {
                                                                            ...
                                                                            playerAudio4Ref.current.src = audioEl.current[index].src
                                                                            playerImage4Ref.current.src = imageEl.current[index].src
                                                                            
                                                                            playerName4Ref.current.innerHTML = musicNameEl.current[index].innerHTML
