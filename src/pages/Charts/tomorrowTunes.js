                            ...
                            //          };
                                     ...
                                     const musicBoxEl = useRef(null);
                                          musicBoxEl.current = [];
                                              ...
                                              return (
                                                <div  className='bg-opacity-[0%] overflow-x-hidden' style={{backgroundImage: "url('tomorrowTunes.svg')", backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center'}}>
                                                            ...
                                                            return (
                                                                <> 
                                                                       <div key={index} ref={musicBoxToEl} onClick={() => {
                                                                            ...
                                                                            playerAudio5Ref.current.src = audioEl.current[index].src
                                                                            playerImage5Ref.current.src = imageEl.current[index].src
                                                                            
                                                                            playerName5Ref.current.innerHTML = musicNameEl.current[index].innerHTML
