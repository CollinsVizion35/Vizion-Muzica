...
const GoldenAge = () => {
    ...
    return (
        <div  className='bg-opacity-[0%] overflow-x-hidden' style={{backgroundImage: "url('mj.jpg')", backgroundRepeat: 'no-repeat', backgroundSize: 'cover', backgroundPosition: 'center'}}>
                    ...
                    return (
                        <> 
                               <div key={index} ref={musicBoxToEl} onClick={() => {
                                    ...
                                    playerAudio6Ref.current.src = audioEl.current[index].src
                                    playerImage6Ref.current.src = imageEl.current[index].src
                                    
                                    playerName6Ref.current.innerHTML = musicNameEl.current[index].innerHTML
