        ...
        <div className="bg-[#1D2123] text-white flex flex-col lg:flex-row">
          ...
          <div className="Body w-[9/10] flex flex-col lg:ml-[5vw] pl-8">
            <div className="lg:flex lg:flex-row grid grid-cols-2 mx-auto lg:mx-[0px]">
              <Link to="/collection">
                <button className="lg:w-max w-[45vw] px-3 py-2 rounded-[20px] border border-[#4F524F] text-[#4F524F] mr-2">
                  My Collection
                </button>
              </Link>

              <Link to="/likes">
                <button className="lg:w-max w-[45vw] px-3 py-2 rounded-[20px] text-[#4F524F] bg-[#FACD66]">
                  Likes
                </button>
              </Link>
            </div>
