                                            ...
                                            return (
                                                ...
                                                <> 
                                                    <div key={index} ref={musicBoxToEl} onClick={() => {
                                                            ...
                                                            playerAudio3Ref.current.src = audioEl.current[index].src
                                                            playerImage3Ref.current.src = imageEl.current[index].src
                                                            
                                                            playerName3Ref.current.innerHTML = musicNameEl.current[index].innerHTML
                                                            playerArtist3Ref.current.innerHTML = artistNameEl.current[index].innerHTML
                                                        }} 
