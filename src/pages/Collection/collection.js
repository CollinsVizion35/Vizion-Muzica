                                            ...
                                            return (
                                                ...
                                                <> 
                                                    <div key={index} ref={musicBoxToEl} onClick={() => {
                                                            ...
                                                            playerAudio2Ref.current.src = audioEl.current[index].src
                                                            playerImage2Ref.current.src = imageEl.current[index].src
                                                            
                                                            playerName2Ref.current.innerHTML = musicNameEl.current[index].innerHTML
                                                            playerArtist2Ref.current.innerHTML = artistNameEl.current[index].innerHTML
                                                        }} 
