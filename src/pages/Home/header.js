            ...
            <SwiperSlide>
              <>
                <div
                  ...
                  className="flex relative w-[95vw] lg:w-[45vw] px-3 h-[60vh] rounded-[50px] mx-auto items-center cursor-pointer flex-row lg:6 justify-between"
                >
                  <div className="flex flex-col justify-around">
                    <div className="text-[0.9em] px-12 ">Currated playlist</div>

                    <div>
                      <div className="text-[1.5em] text-bolder px-12 mt-6">
                        {playlist.name}
                      </div>
                      <div className="text-[0.8em] w-[100%] px-12 mb-[2em]">
                        {playlist.desc}
                      </div>
                    </div>
                    ...
                    <div className="flex flex-row pl-14 pb-8">
                      ...
                      <div className="ml-[1.5em] text-[0.9em]">
                        {playlist.likes}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="w-[20vw] lg:block hidden">
                    <img
                      className="h-[45vw] w-[100%] mt-[2%] mr-[2%]"
                      src={vectorImg}
                      alt="artist"
                    />
                    <img
                      className="absolute right-0 top-0 h-full min-w-[20vw] m-h-[50%] z-[999]"
                      src={playlist.img}
                      alt="artist"
                    />
                  </div>
